...
impl<InstalledPackages: InstalledPackagesProvider> ResolverState<InstalledPackages> {
    ...
    pub(super) fn reprioritize_conflicts(state: &mut ForkState) {
    ...
    /// resolution graph.
    pub(super) fn trace_resolution(combined: &Resolution) {
    ...
    pub(super) fn forks_to_fork_states<'a>(
        &'a self,
    ...
    pub(super) fn version_forks_to_fork_states(
        &self,
        current_state: ForkState,
    ...
    pub(super) fn choose_version_url(
        &self,
        id: Id<PubGrubPackage>,
        name: &PackageName,
        range: &Range<Version>,
    ...
    pub(super) fn choose_version_registry(
        &self,
        package: &PubGrubPackage,
        id: Id<PubGrubPackage>,
        name: &PackageName,
    ...
    pub(super) fn fork_version_registry(
        &self,
        candidate: &Candidate,
        dist: &CompatibleDist,
    ...
    /// the incompatibility.
    pub(super) fn check_requires_python<'dist>(
    ...
    pub(super) fn get_dependencies_forking(
        &self,
        id: Id<PubGrubPackage>,
        package: &PubGrubPackage,
        version: &Version,
    ...
    /// `black[colorama]`).
    pub(super) fn flatten_requirements<'a>(
        &'a self,
    ...
    pub(super) fn requirements_for_extra<'data, 'parameters>(
        &'data self,
    ...
    /// requested extra.
    pub(super) fn is_requirement_applicable(
    ...
    pub(super) fn constraints_for_requirement<'data, 'parameters>(
        &'data self,
    ...
    pub(super) async fn fetch<Provider: ResolverProvider>(
        self: Arc<Self>,
    ...
    pub(super) fn convert_no_solution_err(
        &self,
    ...
    pub(super) fn on_progress(&self, package: &PubGrubPackage, version: &Version) {
...
impl ForkState {
    ...
    pub(super) fn visit_package_version_dependencies(
        &mut self,
    ...
    pub(super) fn add_package_version_dependencies(
        &mut self,
        for_package: Id<PubGrubPackage>,
        for_version: &Version,
    ...
    pub(super) fn add_unavailable_version(&mut self, version: Version, reason: UnavailableVersion) {
    ...
    pub(super) fn with_env(mut self, env: ResolverEnvironment) -> Self {
        self.env = env;
