...
impl PreviewFeature {
    ...
    fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ToolInstallLatestDefault => "tool-install-latest-default",
        }
    }
}
...
impl FromStr for PreviewFeature {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(match s {
            ...
            "tool-install-latest-default" => Self::ToolInstallLatestDefault,
...
mod tests {
    ...
    fn test_preview_feature_as_str() {
        ...
        assert_eq!(
            PreviewFeature::ToolInstallLatestDefault.as_str(),
            "tool-install-latest-default"
        );
    }
}
