...
bitflags::bitflags! {
    ...
    pub struct PreviewFeatures: u32 {
        ...
        const VERSIONED_TOOL_EXECUTABLES = 1 << 18;
    }
}
...
impl PreviewFeatures {
    ...
    fn flag_as_str(self) -> &'static str {
        match self {
            ...
            Self::VERSIONED_TOOL_EXECUTABLES => "versioned-tool-executables",
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        for part in s.split(',') {
            ...
            let flag = match part {
                ...
                "versioned-tool-executables" => Self::VERSIONED_TOOL_EXECUTABLES,
                _ => {
...
mod tests {
    ...
    fn test_as_str_single_flags() {
        ...
        assert_eq!(
            PreviewFeatures::VERSIONED_TOOL_EXECUTABLES.flag_as_str(),
            "versioned-tool-executables"
        );
    }
