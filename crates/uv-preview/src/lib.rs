...
impl PreviewFeature {
    ...
    fn as_str(self) -> &'static str {
        match self {
            ...
            Self::PythonPinPyproject => "python-pin-pyproject",
        }
    }
}
...
impl FromStr for PreviewFeature {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(match s {
            ...
            "python-pin-pyproject" => Self::PythonPinPyproject,
...
mod tests {
    ...
    fn test_preview_feature_as_str() {
        ...
        assert_eq!(
            PreviewFeature::PythonPinPyproject.as_str(),
            "python-pin-pyproject"
        );
    }
