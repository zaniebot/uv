...
impl Tags {
    ...
    pub fn compatibility(
        ...
        // Check for explicitly rejected ABI tags (e.g., abi3 on free-threaded Python)
        if wheel_abi_tags.iter().all(|abi| self.is_abi_rejected(abi)) {
    ...
    /// Returns `true` if this is free-threaded Python (GIL disabled).
    ...
    fn is_abi_rejected(&self, abi: &AbiTag) -> bool {
