...
/// The argument passed to the daemon to indicate it should delete a directory.
pub(crate) const BACKGROUND_CLEAN_ARG: &str = "--internal-background-clean-dir";
...
///
/// This function is called when the daemon is invoked with `--internal-background-clean-dir`.
