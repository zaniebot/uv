...
fn python_greater_than_current_excluded() {
    ...
    ----- stderr -----
      × No solution found when resolving dependencies:
      ╰─▶ Because you are using Python==3.9.[X] which does not satisfy Python>=3.10 and package-a==2.0.0 depends on Python>=3.10, we can conclude that package-a==2.0.0 cannot be used.
          ...
          Because you are using Python==3.9.[X] which does not satisfy Python>=3.11 and package-a==3.0.0 depends on Python>=3.11, we can conclude that package-a==3.0.0 cannot be used.
          ...
          Because you are using Python==3.9.[X] which does not satisfy Python>=3.12 and package-a==4.0.0 depends on Python>=3.12, we can conclude that package-a==4.0.0 cannot be used.
