...
fn python_discovery_starts_at_project_root() -> Result<()> {
    ...
    uv_snapshot!(context.filters(), context.pip_list().arg("--project").arg(project1.as_os_str()), @r"
    success: true
    exit_code: 0
    ----- stdout -----
    Package            Version
    ...
    uv_snapshot!(context.filters(), context.pip_list().arg("--project").arg(project2.as_os_str()), @r"
    success: true
    exit_code: 0
    ----- stdout -----
    Package            Version
