...
fn python_discovery_starts_at_project_root() -> Result<()> {
    ...
    #    uv pip compile --cache-dir [CACHE_DIR] project/pyproject.toml
    anyio==3.0.0
        # via project (project/pyproject.toml)
    idna==3.6
        # via anyio
    sniffio==1.3.1
        # via anyio
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] project/pyproject.toml --project project
    anyio==4.0.0
        # via project (project/pyproject.toml)
    idna==3.6
        # via anyio
