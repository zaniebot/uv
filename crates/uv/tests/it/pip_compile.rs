...
/// Resolve a dependency with a negated extra marker (`extra != '...'`).
///
/// When the extra is NOT activated, the dependency should be included.
/// When the extra IS activated, the dependency should be excluded.
#[test]
fn extra_not_equal_marker() -> Result<()> {
    let context = TestContext::new("3.12");
    ...
    // Without the 'skip' extra, iniconfig should be included.
    uv_snapshot!(context.filters(), context.pip_compile()
        .arg("pyproject.toml"), @r###"
    success: true
    exit_code: 0
    ...
    // With the 'skip' extra, iniconfig should be excluded.
    uv_snapshot!(context.filters(), context.pip_compile()
        .arg("pyproject.toml")
        .arg("--extra")
        .arg("skip"), @r###"
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] pyproject.toml --extra skip
