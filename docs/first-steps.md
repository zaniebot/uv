...
After [installing uv](/uv/installation.md), you can check that uv is available by running the `uv`
command:
...
[overview of features](/uv/features.md) to start using uv.
...
[overview of features](/uv/features.md) or jump to the [guides](/uv/guides/index.md) to start using uv.
