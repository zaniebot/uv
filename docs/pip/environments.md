...
available, uv will download Python for you. See the [Python version](/uv/concepts/python-versions.md)
...
[toolchain discovery](/uv/concepts/python-versions.md#discovery-order) for details on discovery.
