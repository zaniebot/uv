...
[https://docs.python.org/3.12/library/sysconfig.html#installation-paths](https://docs.python.org/3.12/library/sysconfig.html#installation-paths). Usually, small
