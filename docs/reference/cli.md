...
</dd><dt><code>--from-project</code> <i>from-project</i></dt><dd><p>Add all packages listed in the given <code>pyproject.toml</code> file</p>
...
<p>This option is only applicable when the <code>from-project</code> argument is used.</p>
...
</dd><dt><code>--raw-sources</code></dt><dd><p>Adds source requirements to <code>project.dependencies</code> instead of <code>tool.uv.sources</code>.</p>

<p>By default, uv records source information for Git, local, editable, and direct URL requirements under <code>tool.uv.sources</code>. This option is only applicable when the <code>from-project</code> argument is used.</p>
