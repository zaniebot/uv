...
See our guide on [using uv in Docker](/uv/guides/integration/docker.md) for more details.
...
See the [first steps](/uv/first-steps.md) or jump straight to the [guides](/uv/guides/index.md) to start
using uv.
